 ...
 */
final class Version20260302184738 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__credited_person AS SELECT id, created_at, updated_at, created_by, updated_by, sheet_id, person_id FROM credited_person');
        $this->addSql('DROP TABLE credited_person');
        $this->addSql('CREATE TABLE credited_person (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, created_by VARCHAR(255) DEFAULT NULL, updated_by VARCHAR(255) DEFAULT NULL, sheet_id INTEGER NOT NULL, person_id INTEGER NOT NULL, person_type_id INTEGER NOT NULL, CONSTRAINT FK_71F46BD18B1206A5 FOREIGN KEY (sheet_id) REFERENCES sheet (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_71F46BD1217BBB47 FOREIGN KEY (person_id) REFERENCES person (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_71F46BD1E7D23F1A FOREIGN KEY (person_type_id) REFERENCES person_type (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO credited_person (id, created_at, updated_at, created_by, updated_by, sheet_id, person_id) SELECT id, created_at, updated_at, created_by, updated_by, sheet_id, person_id FROM __temp__credited_person');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__credited_person AS SELECT id, created_at, updated_at, created_by, updated_by, sheet_id, person_id FROM credited_person');
        $this->addSql('DROP TABLE credited_person');
        $this->addSql('CREATE TABLE credited_person (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, created_by VARCHAR(255) DEFAULT NULL, updated_by VARCHAR(255) DEFAULT NULL, sheet_id INTEGER NOT NULL, person_id INTEGER NOT NULL, type VARCHAR(100) NOT NULL, CONSTRAINT FK_71F46BD18B1206A5 FOREIGN KEY (sheet_id) REFERENCES sheet (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_71F46BD1217BBB47 FOREIGN KEY (person_id) REFERENCES person (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO credited_person (id, created_at, updated_at, created_by, updated_by, sheet_id, person_id) SELECT id, created_at, updated_at, created_by, updated_by, sheet_id, person_id FROM __temp__credited_person');
        $this->addSql('DROP TABLE __temp__credited_person');
        $this->addSql('CREATE INDEX IDX_71F46BD18B1206A5 ON credited_person (sheet_id)');
        $this->addSql('CREATE INDEX IDX_71F46BD1217BBB47 ON credited_person (person_id)');
